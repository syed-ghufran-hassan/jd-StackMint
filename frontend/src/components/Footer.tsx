...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-purple-500/20 mt-20 bg-gradient-to-b from-transparent to-black/50">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">StacksMint</span>
            </Link>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 hover:bg-purple-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300"
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} StacksMint. All rights reserved.
          </p>
